...
def calculateAge():
    ...
    Label(text=f"Hie {name_value.get()}! your age is: {age}", font=("arial",15, "bold")).grid(row=6, column=1)
...
button=Button(text="Calculate Age", font=("arial", 15, "bold"),fg="red",bg="black", command=calculateAge)
